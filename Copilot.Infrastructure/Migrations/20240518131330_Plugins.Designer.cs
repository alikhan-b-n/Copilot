...
namespace Copilot.Infrastructure.Migrations
{
    ...
    [Migration("20240518131330_Plugins")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Copilot.Infrastructure.Entities.Altegio.AltegioAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AltegioAccounts");
                });

            modelBuilder.Entity("Copilot.Infrastructure.Entities.Altegio.AltegioCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("AltegioAccountId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AltegioAccountId");

                    b.ToTable("AltegioCompanies");
                });
            ...
            modelBuilder.Entity("Copilot.Infrastructure.Entities.Plugin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ParameterData")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Copilot.Infrastructure.Entities.Altegio.AltegioCompany", b =>
                {
                    b.HasOne("Copilot.Infrastructure.Entities.Altegio.AltegioAccount", "AltegioAccount")
                        .WithMany()
                        .HasForeignKey("AltegioAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AltegioAccount");
                });
