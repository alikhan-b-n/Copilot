...
namespace Experimental.Agents.InternalUtilities.System;
...
internal static class InternalTypeConverter
{
    ...
    private static Func<object?, CultureInfo, string?>? GetTypeToStringConverterDelegate(global::System.Type sourceType) =>
    ...
    private static readonly ConcurrentDictionary<global::System.Type, Func<object?, CultureInfo, string?>?> s_converters = new();
}
