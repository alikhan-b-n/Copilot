...
internal static class TypeConverterFactory
{
    ...
    internal static TypeConverter? GetTypeConverter(global::System.Type type)
    {
        ...
        if (type.GetCustomAttribute<TypeConverterAttribute>() is TypeConverterAttribute tca &&
            global::System.Type.GetType(tca.ConverterTypeName, throwOnError: false) is global::System.Type converterType &&
